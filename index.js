...
// // console.log(getUsersWithEyeColor(users1, "green"));
...
// console.log(getUsersWithAge(usersList, 28, 38));
...
// console.log(getUsersWithFriend(userList,"Briana Decker" ));
...
// const getFriends = users => users.flatMap(user => user.friends).filter((friend,idx,array)=>array.indexOf(friend)===idx)

// console.log(getFriends(userList));
...
// console.log(isEveryUserActive(userList));
...
// console.log(isAnyUserActive(usersList));
...
// ];
// // Change code below this line
// const avg = players.map(player=>player.playtime/player.gamesPlayed)
// const totalAveragePlaytimePerGame = avg.reduce((total, average)=>total+=average);
...
// const getSortedFriends = users => users.flatMap(user => user.friends).filter((name, idx, arr) => arr.indexOf(name) === idx).sort((fName, sName) =>
...
// console.log(getTotalBalanceByGender(usersList, "male"));
...
//     let indexItem = this.items.indexOf(itemToRemove);
